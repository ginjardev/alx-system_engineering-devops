#!/usr/bin/python3
"""TFunction to query the Reddit API and return a containing
the titles of all hot articles for a given subreddit. It
prints a sorted count of the number of times each word appears
in the titles
"""
...
def count_words(subreddit, word_list, found_list=[], next_page=None):
    ...
    Args:
        ...
        found_list (list, optional): A list to store the found words.
